        ...
        <central-unit>
            ...
            <div id="main_unit">
                <center>
                    ...
                    <label class="switch"><span class="opt_cn">Показывать ночью только часы</span>
                    ...
                    <table>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Угол поворота дисплея</span></td>
                            <td><select id = "rotate">
                                <option value = "0"> 0 </option>
                        ...
                        <tr><td align = "right">______________________</td></tr>
                        <tr>
                            <td align = "right"><span class="opt_cn">Количество модулей</span></td>
                        ...
                        <tr><td align = "right">______________________</td></tr>
                        <tr>
                            <td align = "right"><span class="opt_cn">Шрифт дисплея</span></td>
