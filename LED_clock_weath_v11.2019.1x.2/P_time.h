...
<html>
    <head>
        ...
        <title>Informer_clock_weath на ESP8266 ver:11.2019.1x.2 (By IvanUA)</title>
    ...
    <body onload = "load_times();">
        <header>
            <span class="opt_cn">ИНФОРМАТОР на ESP8266 вер. 11.2019.1X.2 (by IvanZah)</span><br>
        ...
        <central-unit>
            ...
            <div id="main_unit">
                <paragraph><span class="opt_cn">Сервер точного времени, например, "ntp3.stratum2.ru"</span></paragraph>
                <span class="opt_cn">Введите адрес сервера</span>
                <input type="text" class="field" id="ntpServerName" value="{{ntpServerName}}" class="form-control" pattern="[0-9a-zA-Z. ]{1,20}"><br>
                <span class="opt_cn">Выберите часовой пояс</span>
                <select id = "timeZone">
                ...
                <br>
                <br>
                <paragraph><span class="opt_cn">Будильник</span></paragraph>
                <center>
                    <table id="table__font">
                        <tr>
                            <td><span class="opt_cn">Номер</span></td>
                            <td><span class="opt_cn">Час</span></td>
                            <td><span class="opt_cn">Минута</span></td>
                            <td><span class="opt_cn">Настройки</span></td>
                        </tr>
                        <tr>
                            <td><span>1</span></td>
                            <td>
                            ...
                            <td>
                                <select id="al_0_2">
                                    ...
                                    <option value="8">Пн-Пт (2-6)</option>
                                    <option value="9">Пн-Сб (2-7)</option>
                                    <option value="10">Сб-Вс (6+1)</option>
                                    <option value="1">Вс (1)</option>
                                    <option value="2">Пн (2)</option>
                                    <option value="3">Вт (3)</option>
                                    <option value="4">Ср (4)</option>
                                    <option value="5">Чт (5)</option>
                                    <option value="6">Пт (6)</option>
                                    <option value="7">СБ (7)</option>
                ...
                <center>
                    <table id="table__font">
                        <tr>
                            <td><span class="opt_cn">Номер</span></td>
                            <td><span class="opt_cn">День</span></td>
                            <td><span class="opt_cn">Месяц</span></td>
                            <td><span class="opt_cn">Сообщение</span></td>
                        </tr>
                        <tr>
                            <td><span>1</span></td>
                            <td>
                ...
                <center>
                    <table id="table__font">
                        <tr>
                            <td><span class="opt_cn">Показывать памятные даты с</span></td>
                            <td>
                                <select id="md_start">
                                    <option value = "0"> 0 </option>
                                    <option value = "1"> 1 </option>
                ...
                <br>
                <span class="save_booton" onclick="set_ntp(this);">Сохранить</span>
                <br>
