    ...
    <head>
        ...
        <script type = "text/javascript">
            ...
            function set_weather(submit) {
                server = "/weather?weatherKey0=" + val('weatherKey0') + "&cityID0=" + val('cityID0')+ "&cityID1=" + val('cityID1');
            ...
            <div id="main_unit">
                ...
                <center>
                    <table>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Город (название или код)</span></td>
                            <td><input type="text" class="field" id="cityID1" value="{{cityID1}}" class="form-control" pattern="[ 0-9a-zA-Zа-яА-Я._]{1,32}"></td>
                        </tr>
                    </table>
                </center>
                <center>
                    <label class="switch"><span class="opt_cn">Отображать прогноз погоды (Да/Нет)</span>
                ...
                <center>
                    <table>
                      <tr>
                        <td align = "right"><span class="opt_cn">Отображать бегущую строку с</span></td>
                ...
                <span class="center"><b>МЕСТО НАХОЖДЕНИЯ</b></span>
                <center>
                    <table>    
                        <tr>
                            <td align = "right"><span class="opt_cn">Название города:</span></td>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Часть света:</span></td>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Время восхода GMT:</span></td>
                            <td><span class="opt_cn">{{location_sunrise}}</span></td>
                        </tr>
                        <tr>
                            <td align = "right"><span class="opt_cn">Время заката GMT:</span></td>
                ...
                <span class="save_booton" onclick="set_weather(this);", "load_weath();">Сохранить</span>
                <br>
