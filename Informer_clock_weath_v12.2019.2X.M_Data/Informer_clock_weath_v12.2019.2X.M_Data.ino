...
void sensors() {
  ...
  t3 = (sensorUl==0?0:sensorUl==1?tempDs18b20:sensorUl==2?celsiusSi7021:sensorUl==3?tempBmp:sensorUl==4?tempBme:0);
  t3 += corrTempU;
  t4 = int(t3*-1);
  t5 = int(t3*10*(t3>0?1:-1))%10;
  t6 = (sensorHome==0?0:sensorHome==1?tempDs18b20:sensorHome==2?celsiusSi7021:sensorHome==3?tempBmp:sensorHome==4?tempBme:0);
  t6 += corrTempH;
  t7 = int(t6);
