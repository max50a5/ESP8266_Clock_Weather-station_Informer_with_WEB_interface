...
<b> ver.18.12.2019 </b> <br>
- перевел на русский
- убрал летнее время(всегда выключено)
- убрал DHT
- убрал MQTT
- убрал NARODMON
- убрал второй погодный сервер
- убрал название города в прогнозе
- направление ветра теперь выводится так : С, СВ, В, ЮВ, Ю, ЮЗ, З, СЗ(в том числе и в прогнозе на завтра)
- добавил выравнивание статических данных во 2 строке(в том числе и для больших часов ночью), 
- можно отдельно отключить почасовой сигнал или бип при сохранении
- добавил "года" после вывода года для всех языков
- поменял местами мин. и макс. температуры для прогноза
